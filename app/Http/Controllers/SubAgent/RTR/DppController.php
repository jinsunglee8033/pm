...
class DppController extends Controller
{
    ...
    public function process(Request $request) {
        ...
        try {
            ...
            ### process DPP vendor API - Dollarphone Pinless first month ###
            Helper::log('##### CALL activateOrRechargeAccount ###');

            $ret = DollarPhone::recharge($trans->id, $trans->phone, $face_value, $vendor_denom->rtr_pid); //
            ...
            if (!empty($error_msg)) {
                ...
                $msg .= ' - error : ' . $error_msg;
                Helper::send_mail('it@jjonbp.com', '[PM][' . getenv('APP_ENV') . '] Dollarphone Pinless - applyRTR 1st month failed', $msg);
            }
            ...
            if ($collection_amt > 0) {
                ...
                if (!empty($ret['error_code'])) {
                    ...
                    Helper::send_mail('it@jjonbp.com', '[PM][' . getenv('APP_ENV') . '] Dollarphone Pinless RTR - create commission failed', $msg);
                }
            }
            ...
            Helper::send_mail('it@jjonbp.com', 'Dollarphone Pinless RTR Failed', $msg);

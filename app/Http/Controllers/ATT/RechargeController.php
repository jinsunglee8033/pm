    ...
    public static function process_after_pay($invoice_number) {
        ...
        try {
            ...
            if ($ret['error_code'] != '') {
                ...
                Helper::send_mail('it@perfectmobileinc.com', '[PM][' . getenv('APP_ENV') . '] Domestic RTR - failed', $msg);

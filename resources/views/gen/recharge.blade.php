        ...
        function check_phone(){
            ...
            $.ajax({
                ...
                success: function(res) {
                    myApp.hideLoading();
                    if (res.code === '0') {
                        $('#balance_wallet').val(res.balance_wallet);
                        $('#customer_id').val(res.customer_id);
                        $('#plan_code').val(res.plan_code);
                        myApp.showMsg('This phone number is available.');
                    } else {
                        alert(res.msg);
                        $('#phone').val('');
                    }
...
{{--                                <a href="/gen/recharge" class="btn dark"> <h4>PIN Redemption</h4> </a>--}}
                                ...
                                <a href="/gen/recharge" class="btn dark"><h4>Recharge</h4></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <form class="form-horizontal" id="frm_recharge" role="form" method="post" action="/rok/recharge" onsubmit="myApp.showLoading();">
                                            ...
                                            <input type="hidden" id="balance_wallet" value="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" type="text" id="phone" name="phone" maxlength="10" placeholder="10 digits and digit only." onchange="check_phone()"/>
                                                ...
                                                <div class="col-md-2">
                                                    <a class="btn btn-info btn-sm" style="margin-top: 4px;">
                                                        Check
                                                    </a>
                                                </div>
                                            </div>

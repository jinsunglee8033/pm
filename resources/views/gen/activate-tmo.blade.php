    ...
    <script type="text/javascript">
        ...
        function change_source() {
            ...
            if($('#sim').val().length != 19){
                alert("SIM length is required 19 digits only");
                return;
            }
        ...
        function check_sim() {
            ...
            if($('#sim').val().length < 18 || $('#sim').val().length > 21){
                alert("Sim Length from 18 to 21");
                return;
            }
        ...
        function request_activation() {
            ...
            if ($('#zip').val().length !=5){
                alert("Please Insert 5-Digit zip");
                return;
            }
                        ...
                        <div class="page-head2">
                            <div class="container">
                                ...
                                <div class="btn-group btn-group btn-group-justified">
                                    ...
                                    <a href="/gen/activate-tmo" class="btn dark"><h4>ACTIVATION (TMO)</h4></a>
                                    ...
                                    <div class="row">
                                        <form id="frm_act" method="post" class="row marginbot15">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                                                        <label style="color: #ffdd05"><input type="radio" name="network" onclick="window.location.href='/gen/activate';"/>  SPR </label> &nbsp;&nbsp;
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-3" align="left">
                                                    <a class="btn btn-info btn-xs" href="#" onclick="change_source()">
                                                        Enter
                                                    </a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-5" align="right"
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value=""
                                                               maxlength="5"
                                                               placeholder="Please Insert Zip Code"
                                                               onblur="check_zip()"
                                                        />
...
{{--                                                <div id="error_amount" class="hidden" style="color: red">Total is can not be $0.00</div>--}}
                                                <div class="col-sm-12">
                                                    <div class="col-sm-4" align="right"
                                                         style="">
                                                        <div class="form-group">

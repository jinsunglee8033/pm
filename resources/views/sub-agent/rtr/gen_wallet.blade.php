...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function check_mdn_wallet() {
            $('#current_plan_amount').text('');
            $('#current_plan_name').text('');

            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/rtr/gen/check_mdn_wallet',
                data: {
                    mdn: $('#mdn').val()
                },
                type: 'get',
                ...
                success: function(res) {
                    ...
                    if (res.code === '0') {
                        ...
                        // $('#current_plan_amount').text('$' + res.current_plan_amount);
                        // $('#current_plan_name').text('$' + res.current_plan_name);
        ...
        function onchange_amount() {
            ...
            var total_amt = amount + parseFloat(processing_fee);

            $('#plan_amount_text').text(amount.toFixed(2));
            $('#total_amount_text').text(total_amt.toFixed(2));
        }
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.code == '0') {
                        ...
                        window.location.href = '/sub-agent/wallet/gen/success/' + res.data.id;
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Refill Wallet Success</h4>
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="tabbable tab">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="#" style="cursor: pointer;" class="black-tab">Wallet</a>
                            </li>
                            <li>
                            ...
                            <form id="frm_act" method="post" class="row marginbot15">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-3" align="left">
                                        <a class="btn btn-info btn-xs" onclick="check_mdn_wallet()">
                                            Enter
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div id="info_box" style="display: none;">
                                    ...
                                    <div class="col-sm-12" style="margin-top: 16px;">
                                        <div class="col-sm-4" align="right"
                                             style="">
                                            <div class="form-group">
                                                <label class="required">Amount ($5.00 ~ $100.00)</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-5" align="left">
                                            <input type="text" class="form-control"

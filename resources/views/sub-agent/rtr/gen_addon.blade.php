...
@section('content')
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.code === '0') {
                        ...
                        $.each(res.addon_denoms, function(k, v) {
                            if (v.rtr_pid !== 'GENTALK05' || res.plancode == '35') {
                                var tr = '<tr>';
                                tr += '<td style="text-align:center;"><input type="radio" value="' + v.denom_id + '" ' +
                                    'name="denom_id" onclick="plan_selected_processing_fee(' + v.denom_id + ')"></td>';
        ...
        function recharge_submit() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/rtr/gen_addon/post',
                data: data,
                type: 'post',
                dataType: 'json',
                cache: false,
                success: function(res) {
                    ...
                    if (res.code == '0') {
                        ...
                        window.location.href = '/sub-agent/rtr/gen_addon/success/' + res.data.id;
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Refill Add-on Success</h4>
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="tabbable tab">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="#" style="cursor: pointer;" class="black-tab">Add-Ons</a>
                            </li>
                            <li>
                                ...
                                <div id="info_box" style="display: none;">
                                    ...
                                    <div class="col-sm-12" style="margin-top: 16px;">
                                        <div class="col-sm-4" align="right"
                                             style="">
                                            <div class="form-group">
                                                <label class="required">Another Add-ons</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-5" align="left">
                                            <table class="table table-bordered">

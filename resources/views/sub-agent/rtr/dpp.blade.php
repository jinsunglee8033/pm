...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function refresh_page() {
            $('#frm_rtr').attr('action', '/sub-agent/rtr/dpp');
            $('#frm_rtr').submit();
        }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Dollarphone Pinless - RTR Success</h4>
                    </div>
            ...
            <div class="inner-head">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4>Dollarphone Pinless</h4>
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Dollarphone Pinless</li>
                        </ol>
                    </div>
                </div>
            </div>
...
{{--                        <div class="panel-body">--}}
                            <form id="frm_rtr" method="post" class="form-horizontal" action="/sub-agent/rtr/dpp/process" onsubmit="myApp.showLoading()">
                                {!! csrf_field() !!}

                                <div class="col-sm-2">
                                    <img src="/img/category-img-dollarphone.jpg" style="width: 250px; margin-bottom: 16px;">
                                </div>

                                <input type="hidden" name="carrier" value="Dollarphone Pinless">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-6" align="right" style="padding-top: 3px;">

...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function check_mdn() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/rtr/gen/check_mdn_for_mdn_swap',
                data: {
                    mdn: $('#mdn').val()
                },
                type: 'get',
        ...
        function mdn_swap_post() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/rtr/gen/mdn_swap_post',
                data: {
                    pin: $('#pin').val(),
                ...
                success: function(res) {
                    ...
                    if (res.code === '0') {
                        myApp.showSuccess('Your request has been processed successfully!', function() {
                            location.href = "/sub-agent/rtr/gen_mdn_swap";
                        });
                    } else {
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="tabbable tab">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="#" style="cursor: pointer;" class="black-tab">MDN Swap</a>
                            </li>
                            <li>
                                            ...
                                            <div class="col-sm-5" align="right" style="padding-top: 3px;">
                                                <div class="form-group">
                                                    ...
                                                    <div id="count" align="left" style="color: red;
                                                                font-size: 12px;
                                                                margin-left: 10px;">
                                                        You have entered in <span id="new_zip_count" style="font-weight: bold;">0</span> Digits
                                                    </div>
                                                    <div id="error_msg_new_zip"></div>
                                                </div>
                                                <div class="divider2"></div>
                                            </div>
                                            <div class="col-sm-3" align="left">
                                                <a class="btn btn-info btn-xs" onclick="mdn_swap_post()">
                                                    Submit
                                                </a>
                                            </div>
                                ...
                                @else
                                    <div class="col-sm-8">
                                        <div class="col-sm-6" align="right"
                                             style="">
                                            <div class="form-group">
                                                <label class="required">MDN Swap function OFF. Please contact our customer care</label>
                                            </div>
                                        </div>
                                    </div>
                                @endif

...
@section('content')
            ...
            <div class="inner-head">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4>Shop</h4>
                        <ol class="breadcrumb">
                            <li><a href="/sub-agent">Home</a></li>
                            <li class="active">Shop</li>
                            <li><a href="/sub-agent/virtual-rep/cart">Cart</a></li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <form id="frm_quick_search_promotion" class="form-horizontal" method="post" action="/sub-agent/virtual-rep/shop">
        {{ csrf_field() }}

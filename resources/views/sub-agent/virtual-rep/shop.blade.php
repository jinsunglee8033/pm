...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function save_vr_request() {
            ...
            $.ajax({
                url: '/sub-agent/virtual-rep/save',
                data: {
                    _token: '{!! csrf_token() !!}',
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="/sub-agent/virtual-rep/cart">View Cart / Proceed to Checkout</a></li>
    ...
    <div class="contain-wrapp padding-bot50">
        ...
        <div class="floating">
            <a href="/sub-agent/virtual-rep/cart" class="btn btn-default" style="margin-bottom: 10px; margin-top: -10px;">View Cart</a>
        </div>

        <div class="container-fluid" style="width: 100%;">
            <div class="row">
                <div class="col-md-2 col-sm-3 col-xs-12">
                <form id="frm_search" class="form-horizontal" method="post" action="/sub-agent/virtual-rep/shop">
                    {{ csrf_field() }}
                    <aside>
                        <div class="widget">
{{--                            <h5 class="widget-head">Quick Search</h5>--}}
                        ...
                        <div style="margin-top: 2px;">
                            <a href="/sub-agent/virtual-rep/shop" class="btn btn-info btn-block">Refresh</a>
                        </div>
                            ...
                            <div class="product-containt">
                                ...
                                <p style="white-space: nowrap;">Allocation:
                                    <span style="color:#ff4629;">
                                        @if ( $o->sub_max_final === 0 )
                                            0
                                        @elseif ( !empty($o->sub_max_final) )
                                            {{ $o->sub_max_final }}
                                        @endif
                                    </span>
                                </p>
                                <p>Remaining:
                                    <span style="color:#ff4629;">
                                        @if( $o->sub_max_final === 0 )
                                            0
                                        @elseif ( !empty($o->sub_max_final) )
                                            {{ $o->sub_max_final - $o->s_ordered_qty }}
                                        @endif
                                    </span>
                                </p>
                                ...
                                <div class="row2">
                                    <div class="price">
                                        <span style="font-size: 14px">${{$o->sub_price_final}}</span>
    ...
    <form id="frm_quick_search" class="form-horizontal" method="post" action="/sub-agent/virtual-rep/shop">
        {{ csrf_field() }}

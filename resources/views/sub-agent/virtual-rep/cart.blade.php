...
@section('content')
    ...
    <script type="text/javascript">
            ...
            paypal.Button.render({
                ...
                onAuthorize: function (data, actions) {
                    ...
                    return actions.payment.execute().then(function () {
                        ...
                        location.href="/sub-agent/reports/vr-request";

                        {{--$.ajax({--}}
                        {{--    url: '/sub-agent/virtual-rep/cart/paid',--}}
                        {{--    data: {--}}
                        {{--        _token: '{!! csrf_token() !!}',--}}
                        {{--        vr_id: $('#vr_id').val(),--}}
        ...
        function do_proceed() {
            ...
            if (mtd == 'PayPal') {
                $.ajax({
                    url: '/sub-agent/virtual-rep/cart/status',
                    data: {
                        vr_id: $('#vr_id').val(),
                ...
                $.ajax({
                    url: '/sub-agent/virtual-rep/cart/cod',
                    data: {
                        order_notes: $('#order_notes').val(),
                        promo_code: $('#promo_code').val(),
                        payment_method: mtd,
        ...
        function add_to_cart(id) {
            ...
            $.ajax({
                url: '/sub-agent/virtual-rep/add_to_cart',
                data: {
                    id: id,
                    qty: qty
                },
                ...
                success: function(res) {
                    ...
                    if ($.trim(res.msg) === '') {
                        ...
                        location.href = "/sub-agent/virtual-rep/cart";
                    } else {
                        $('#qty_'+id).val('0');
                        alert(res.msg);
                        location.href = "/sub-agent/virtual-rep/cart";
            ...
            <div class="inner-head">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <b>
                        <ol class="breadcrumb">
                            <li><a href="/sub-agent/virtual-rep/shop">Order</a></li>
                            <li class="active">View Cart / Proceed to Checkout</li>
                            <li><a href="/sub-agent/reports/vr-request">Track My Order</a></li>
                            <li><a href="/sub-agent/virtual-rep/general_request">General Request</a></li>
                        </ol>
                        </b>
                    </div>
                </div>
    ...
    <div class="floating">
        <a href="/sub-agent/virtual-rep/shop" class="btn btn-default" style="margin-bottom: -10px; margin-top: 10px;">Continue Shopping</a>
    </div>
        ...
        @else
                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($v->product->category != 'SHIPPING FEE')
                                    <a href="/sub-agent/virtual-rep/cart/remove/{{ $v->id }}" class="remove"><i class="fa fa-remove"></i></a>
                                @endif
                                </td>
                            </tr>
                            @endforeach   
                        ...
                        <div class="col-md-6">
                            ...
                            <script>
                                function update_shipping_method() {
                                    window.location.href = '/sub-agent/virtual-rep/cart/shipping_method/' + $('#shipping_method').val();
                                }
                            </script>
                            <div class="divider2"></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">   
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="checkbox col-sm-12">
                                <label>
                                    <input type="radio" name="payment_method" value="Balance" checked> Pay by Account Balance
                                </label>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12" style="float: right">
                    <a type="submit" class="btn btn-primary btn-block" onclick="do_proceed()" >Proceed to checkout</a>
                </div>
                @endif

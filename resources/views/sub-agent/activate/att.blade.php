...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function change_source() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/att/sim',
                data: {
                    sim: $('#sim').val()
                },
                type: 'get',
        ...
        function request_activation() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/att/post',
                data: data,
                type: 'post',
                dataType: 'json',
                cache: false,
                success: function(res) {
                    ...
                    if (res.code == '0') {
                        ...
                        window.location.href = '/sub-agent/activate/att/success/' + res.data.id;
        ...
        function get_commission() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/att/commission',
                data: {
                    sim: sim,
                    imei: imei,
                    denom_id: denom_id,
...
{{--        </marquee>--}}
    ...
    <form id="frm_att_rtr" method="post" action="/sub-agent/rtr/domestic">
        ...
        <input type="hidden" name="product_id" value="WATTR">
    </form>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="tabbable tab">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="/sub-agent/activate/att" class="black-tab">AT&T USA</a>
                            </li>
                            <li>
                                <a onclick="att_recharge()" style="cursor: pointer;">AT&T USA Recharge</a>
                            </li>
                            <li>
                                <a onclick="att_transactions()" style="cursor: pointer;">AT&T USA Transactions</a>
                            </li>
                            <li>
                                <a href="/sub-agent/tools/att">AT&T Tools</a>
                            </li>
...
{{--                            </li>--}}
            ...
            <div class="tab-content" style="padding-top:36px;">
                <div class="row">
                    <div class="col-sm-2">
                        <img src="/img/category-img-att-usa.jpg" style="width: 100%; margin-bottom: 16px;">
                    </div>

                    <div class="col-sm-10">

                        @if (Helper::over_activation('AT&T') != '')
                            {!! Helper::over_activation('AT&T') !!}
                        @else
                            <div class="row">

                                @if ($account->act_att == 'Y' && \App\Lib\Helper::check_parents_product($account->id, 'WATTA') =='Y')

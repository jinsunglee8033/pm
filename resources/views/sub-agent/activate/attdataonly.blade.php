...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function change_source() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/attdataonly/sim',
                data: {
                    sim: $('#sim').val()
                },
                type: 'get',
        ...
        function portin_checked() {
            ...
            if (checked) {
                myApp.showLoading();
                $.ajax({
                    url: '/sub-agent/activate/attdataonly/get_portin_form',
                    type: 'get',
                    dataType: 'html',
                    cache: false,
                    success: function(res) {
        ...
        function request_activation() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/attdataonly/post',
                data: data,
                type: 'post',
                dataType: 'json',
                cache: false,
                success: function(res) {
                    ...
                    if (res.code == '0') {
                        ...
                        window.location.href = '/sub-agent/activate/attdataonly/success/' + res.data.id;
        ...
        function get_commission() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/attdataonly/commission',
                data: {
                    sim: sim,
                    imei: imei,
                    denom_id: denom_id,
            ...
            <div class="modal-content">
                ...
                <div class="modal-body receipt" id="activate_invoice_body">
                    <p>
                        ...
                        Please refer to "Reports -> Activation" for more information.
                    </p>
                    <div class="row">
            ...
            <div class="inner-head">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4>Activation Data Only</h4>
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Activation Data Only</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    @php
    $promotion = Helper::get_promotion('AT&T');
    @endphp
    @if (!empty($promotion))
...
{{--        </marquee>--}}
    ...
    <form id="frm_att_rtr" method="post" action="/sub-agent/rtr/domestic">
        ...
        <input type="hidden" name="product_id" value="WATTDO">
    </form>
    ...
    <div class="contain-wrapp padding-bot70 no-print" style="">
        <div class="container">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="tabbable tab">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="/sub-agent/activate/attdataonly" class="black-tab">AT&T Data Only</a>
                            </li>
                            <li>
                                <a onclick="att_recharge()" style="cursor: pointer;">AT&T Data Only Recharge</a>
                            </li>
                            <li>
                                <a onclick="att_transactions()" style="cursor: pointer;">AT&T USA Transactions</a>
                            </li>
                            <li>
            ...
            <div class="tab-content" style="padding-top:36px;">
                <div class="row">
                    <div class="col-sm-2">
                        <img src="/img/category-img-att-dataonly.jpg" style="width: 100%; margin-bottom: 16px;">
                    </div>
                    <div class="col-sm-10">

                        @if (Helper::over_activation('AT&T Data Only') != '')
                            {!! Helper::over_activation('AT&T Data Only') !!}
                        @else
                            <div class="row">

                                @if ($account->act_att == 'Y' && \App\Lib\Helper::check_parents_product($account->id, 'WATTDO') == 'Y')

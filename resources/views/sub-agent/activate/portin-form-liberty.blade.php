    ...
    <div class="col-sm-4">
        <div class="form-group">
            <input type="text" class="form-control"
                   id="port_in_mdn" name="port_in_mdn" value="" maxlength="10" placeholder="10 digits and digits only"/>
...
{{--    <div class="col-sm-4" align="right">--}}
{{--        <div class="form-group">--}}
{{--            <label class="required">MDN</label>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--        <div class="form-group">--}}
{{--            <input type="text" class="form-control"--}}
{{--                   id="mdn" name="mdn" value="" maxlength="10" placeholder="10 digits and digits only"/>--}}
{{--            <div id="error_msg_mdn"></div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
...
<div class="col-sm-12">
   ...
   <div class="col-sm-4">
    <div class="form-group">
        <input type="text" class="form-control" id="street_number" name="street_number" placeholder="House Number Only (Unnecessary filled will occur error)" />
...
<div class="col-sm-12">
   ...
   <div class="col-sm-4">
    <div class="form-group">
        <input type="text" class="form-control" id="street_name" name="street_name" placeholder="Name of Street Only" />

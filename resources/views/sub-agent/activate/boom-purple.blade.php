...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function change_source() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/boom/sim_purple',
                data: {
                    sim: $('#sim').val()
                },
                type: 'get',
        ...
        function portin_checked() {
            ...
            if (checked) {
                myApp.showLoading();
                $.ajax({
                    url: '/sub-agent/activate/boom/get_portin_form_purple',
                    type: 'get',
                    dataType: 'html',
                    cache: false,
                    success: function(res) {
        ...
        function get_commission() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/activate/boom/commission_purple',
                data: {
                    sim: sim,
                    meid: meid,
                    denom_id: denom_id,
        ...
        function request_activation() {
            ...
            $.ajax({
                url: '/sub-agent/activate/boom/post_purple',
                data: data,
                type: 'post',
                dataType: 'json',
                cache: false,
    ...
    @php
        $promotion = Helper::get_promotion('Boom Purple');
    @endphp
    @if (!empty($promotion))
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="tabbable tab">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="/sub-agent/activate/boom_purple" class="black-tab">Boom Purple Activation</a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content" style="padding-top:36px;">
                            <form id="frm_act" method="post" class="row marginbot15">
                                ...
                                <label style="color: #6600ff; margin-left: -65%; margin-top: 6%">PURPLE</label>
                                @if (Helper::over_activation('Boom Purple') != '')
                                    <div class="col-sm-8">
                                    {!! Helper::over_activation('Boom Purple') !!}
                                    </div>
                                @else


                                    @if ($account->act_boom == 'Y' && \App\Lib\Helper::check_parents_product($account->id, 'WBMPA') == 'Y')
                                        <div class="col-sm-8">
    ...
    {{--                                        </div>--}}
            ...
            {!! Helper::get_reminder('Boom Purple') !!}

                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{{ $o->label }} : 
                                        @if ( $o->key == 'FILE_W_9')
                                            @if ($o->file == null)
                                                <br><a class="float:right" href="/sub-agent/esig/FILE_W_9" target="_blank">eSignature</a>
                                                <br><a class="float:right" href="/upload_template/W9_Form.pdf" target="_blank">form download</a>
                                            @else
                                                @if($o->file->locked == 'Y')
                                                    <br><a class="float:right" href="/upload_template/W9_Form.pdf" target="_blank">form download</a>
                                                @else
                                        ...
                                        @if ( $o->key == 'FILE_PR_SALES_TAX')
                                            @if ($o->file == null)
                                                <br><a class="float:right" href="/sub-agent/esig/FILE_PR_SALES_TAX" target="_blank">eSignature</a>
                                                <br><a class="float:right" href="/upload_template/PR_SALES_TAX.pdf" target="_blank">form download</a>
                                            @else
                                                @if($o->file->locked == 'Y')
                                                    <br><a class="float:right" href="/upload_template/PR_SALES_TAX.pdf" target="_blank">form download</a>
                                                @else
                                        ...
                                        @if ( $o->key == 'FILE_USUC')
                                            @if ($o->file == null)
                                                <br><a class="float:right" href="/sub-agent/esig/FILE_USUC" target="_blank">eSignature</a>
                                                <br><a class="float:right" href="/upload_template/FILE_USUC.pdf" target="_blank">form download</a>
                                            @else
                                                @if($o->file->locked == 'Y')
                                                    <br><a class="float:right" href="/upload_template/FILE_USUC.pdf" target="_blank">form download</a>
                                                @else
                                        ...
                                        @if ( $o->key == 'FILE_ACH_DOC')
                                            @if($o->file == null)
                                                <br><a class="float:right" href="/sub-agent/esig/FILE_ACH_DOC" target="_blank">eSignature</a>
                                                <br><a class="float:right" href="/upload_template/ACH_FORM.pdf" target="_blank">form download</a><br><a class="float:right" href="/upload_template/Check_List.pdf" target="_blank">Check List</a>
                                            @else
                                                @if ($o->file->locked =='Y')
                                                    <br><a class="float:right" href="/upload_template/ACH_FORM.pdf" target="_blank">form download</a><br><a class="float:right" href="/upload_template/Check_List.pdf" target="_blank">Check List</a>
                                                @else
                                            ...
                                            @endif
                                        @endif
                                        @if ( $o->key == 'FILE_BANK_REFERENCE')
                                        <br><a class="float:right" href="/upload_template/BANK_REFERENCE.pdf" target="_blank">form download</a>
                                        @endif
                                        @if ( $o->key == 'FILE_BUSINESS_CERTIFICATION')
                                            <br><a class="float:right" href="/upload_template/MERCHANT_GUARANTY_AGREEMENT.pdf" target="_blank">form download</a>
                                        @endif

...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function update_hour(day, user) {
            ...
            $.ajax({
                url: '/sub-agent/setting/user-hour/update',
                data: {
                    _token: '{!! csrf_token() !!}',
                ...
                success: function(res) {
                    ...
                    if ($.trim(res.msg) === '') {
                        ...
                        myApp.showSuccess('Your request has been processed successfully!', function() {
                            location.href = "/sub-agent/setting/user-hour";
                        });
        ...
        function remove_hour(day, user) {
            ...
            $.ajax({
                url: '/sub-agent/setting/user-hour/remove',
                data: {
                    _token: '{!! csrf_token() !!}',
                    day: day.substr(day.length - 3),
                    user: user,
        ...
        function remove_ip(id) {
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/setting/user-hour/remove-ip',
                data: {
                    _token: '{!! csrf_token() !!}',
                    id: id
                },
        ...
        function add_ip() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/sub-agent/setting/user-hour/add-ip',
                data: {
                    _token: '{!! csrf_token() !!}',

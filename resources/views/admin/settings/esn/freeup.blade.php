...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function save_esn_assign() {
            myApp.showLoading();
            $.ajax({
                url: '/admin/settings/esn/freeup/assign',
                data: {
                    _token: '{!! csrf_token() !!}',
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="title">Upload FreeUP ESN</h4>
                </div>
                <div class="modal-body">

                    <form id="frm_upload" action="/admin/settings/esn/freeup/upload" class="form-horizontal filter" method="post" style="padding:15px;" target="ifm_upload" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group">
                ...
                <div class="modal-footer" style="margin-right:15px;">
                    <a class="btn btn-warning" href="/upload_template/freeup_esn_upload_template.xlsx" target="_blank">Download Template</a>
    ...
    <div class="modal" id="div_batch_lookup" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frm_batch_lookup" action="/admin/settings/esn/freeup/batch-lookup" class="form-horizontal filter"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="frm_upload" action="/admin/settings/freeup-sims/assign" class="form-horizontal filter" method="post" style="padding:15px;">
                        {{ csrf_field() }}

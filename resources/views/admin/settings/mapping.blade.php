...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function save_mapping() {
            myApp.showLoading();
            $.ajax({
                url: '/admin/settings/mapping/bind',
                data: {
                    _token: '{!! csrf_token() !!}',
    ...
    <div class="modal" id="div_batch_lookup" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frm_batch_lookup" action="/admin/settings/mapping/batch-lookup" class="form-horizontal filter"
                          method="post" style="padding:15px;">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <select class="form-control" name="product">
                                    <option value="" {{ old('product', $product) == '' ? 'selected' : '' }}>Select Product
                                    </option>
                                    @foreach ($products as $p)

...
@section('content')
            ...
            <div class="inner-head">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h4>Spiff Setup Report</h4>
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li><a href="#">Reports</a></li>
                            <li class="active">Spiff Setup Report</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="contain-wrapp padding-bot70">
        <div class="well filter" style="padding-bottom:5px;">
            <form id="frm_search" class="form-horizontal" method="post" action="/admin/reports/spiff-setup-report">
                {{ csrf_field() }}
        ...
        <table class="table table-bordered table-hover table-condensed filter">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center">Spiff.1st</th>
                    <th style="text-align: center">Spiff.2nd</th>
                    <th style="text-align: center">Spiff.3rd</th>
                </tr>
            </thead>
            <tbody>
                @if (isset($data) && count($data) > 0)
                    @foreach ($data as $o)
                        <tr>
                            ...
                            <td style="text-align: center">{!! Helper::get_hierarchy_img($o->account_type) !!}</td>
                            <td style="text-align: right">${{ $o->spiff_1st}}</td>
                            <td style="text-align: right">${{ $o->spiff_2nd}}</td>
                            <td style="text-align: right">${{ $o->spiff_3rd}}</td>
                        </tr>
                    @endforeach
                @else
                    <tr>

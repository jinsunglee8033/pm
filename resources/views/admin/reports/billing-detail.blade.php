            ...
            <div class="inner-head">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li><a href="/admin/reports/billing">Reports</a></li>
                            <li class="active">Billing Detail</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 text-right">
                                    ...
                                    <a class="btn btn-default btn-sm" href="/admin/reports/billing">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="well">
                        ...
                        <!--div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <span class="form-control">${{ number_format($bill->consignemnt, 2) }}</span>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 text-right">
                    <form method="post" action="/admin/reports/billing/detail/{{ $bill->id }}">
                        {!! csrf_field() !!}

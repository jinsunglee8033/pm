...
@section('content')
    ...
    <h4>ESN/MDN Swap History (GEN Mobile)</h4>

    <div class="well filter" style="padding-bottom:5px;">
        <form id="frm_search" class="form-horizontal" method="post" action="/admin/reports/monitor/esn-swap-history">
            {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="col-md-4 control-label">Sent</label>
                        <div class="col-md-8">
                            <select class="form-control" name="sent" id="sent" data-jcf='{"wrapNative": false, "wrapNativeOnMobile": false}' onchange="set_date()">
                                <option value="" {{ empty($sent) == '' ? 'selected' : '' }}>All</option>
                                <option value="S" {{$sent == 'S' ? 'selected' : '' }}>Success</option>
                                <option value="F" {{$sent == 'F' ? 'selected' : '' }}>Fail</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="type" id="type" data-jcf='{"wrapNative": false, "wrapNativeOnMobile": false}' onchange="set_date()">
                                <option value="" {{ empty($type) == '' ? 'selected' : '' }}>All</option>
                                <option value="ESN Swap" {{$type == 'ESN Swap' ? 'selected' : '' }}>ESN Swap</option>
                                <option value="MDN Swap" {{$type == 'MDN Swap' ? 'selected' : '' }}>MDN Swap</option>
                            </select>
                        </div>
                    </div>
                </div>

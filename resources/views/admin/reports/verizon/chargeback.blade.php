...
<h4>Verizon Charge Back Report</h4>

<div class="well filter" style="padding-bottom:5px;">
    <form id="frm_search" class="form-horizontal" method="post" action="/admin/reports/verizon/chargeback">
        {{ csrf_field() }}
        <input type="hidden" name="excel" id="excel"/>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-4 control-label">CB.Date</label>
                    <div class="col-md-8">
...
<table class="table table-bordered table-hover table-condensed filter">
    ...
    <tr>
        ...
        <td>{{ $o->deactivation_date }}</td>
        <td>{{ $o->days_of_service }}</td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_upload" class="form-horizontal detail" action="/admin/reports/verizon/chargeback/upload" method="post" target="ifm_upload" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">

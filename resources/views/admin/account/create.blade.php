...
@section('content')
    ...
    <script type="text/javascript">
                    ...
                    if (index === 4) {
                        ...
                        if (pay_method === 'C') {
                            ...
                            if (!pattern.test(credit_limit)) {
                                myApp.showError('Please enter valid decimal number(credit_limit)');
                                $('#credit_limit').focus();
                                return false;
                            }
                            ...
                            if (!pattern.test(allow_cash_limit)) {
                                myApp.showError('Please enter valid decimal number(allow_cash_limit)');
                                $('#allow_cash_limit').focus();
                                return false;
                            }
        ...
        function reload_after_create(account_id) {
            ...
            alert("Please don’t forget to create a new Login User ID !");
        ...
        function show_account_detail(id) {
            ...
            var mode = 'new';
            var url = '/admin/account/get-parent-info';
            ...
            $('#no_postpay_check').val("{{$p_account->no_postpay}}");
                ...
                success: function (res) {
                    ...
                    if ($.trim(res.msg) === '') {
                        ...
                        if (res.account) {
                            ...
                            $('#gen_processing_fee').val(res.account.gen_p_fee);
                            $('#gen_activation_fee').val(res.account.gen_a_fee);
                            ...
                            $('#no_postpay').prop('checked', res.account.postpay === 'Y');
                            ...
                            if ($p_account_id == 100000 || res.parent.act_h2o === 'Y') {
                            ...
                            if ($p_account_id == 100000 || res.parent.act_lyca === 'Y') {
                            ...
                            if ($p_account_id == 100000 || res.parent.act_att === 'Y') {
                            ...
                            if ($p_account_id == 100000 || res.parent.act_freeup === 'Y') {
                            ...
                            if ($p_account_id == 100000 || res.parent.act_gen === 'Y') {
                            ...
                            if ($p_account_id == 100000 || res.parent.act_liberty === 'Y') {
                            ...
                            if ($p_account_id == 100000 || res.parent.act_boom === 'Y') {
        ...
        function bind_spiff_templates(res) {
            ...
            if (res.spiff_templates.length > 0) {
                ...
                // $('#att_spiff_template').append('<option value="">Select one.</option>');
                // $('#freeup_spiff_template').append('<option value="">Select one.</option>');
                // $('#gen_spiff_template').append('<option value="">Select one.</option>');
        ...
        function bind_owned_plans(owned_plans) {
        ...
        function show_spiff_template_detail(template_id) {
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    <a href="#address" aria-controls="address"
                       role="tab" data-toggle="tab">Address</a>
                </li>
                <li role="presentation" id="tab_products">
                    <a href="#products" aria-controls="products"
                       role="tab" data-toggle="tab">Activation Products</a>
                </li>
                <li role="presentation" id="tab_wallet">
                    <a href="#wallet" area-controls="wallet"
                       role="tab" data-toggle="tab">Wallet</a>
                </li>
                @if(Auth::user()->account_type == 'L' && in_array(Auth::user()->user_id, ['admin', 'thomas', 'system']))
                <li role="presentation" id="tab_others">
                    <a href="#others" area-controls="others"
                       role="tab" data-toggle="tab">Others</a>
                </li>
                @endif
                <li role="presentation">
                    <a href="#forms" aria-controls="forms"
                       role="tab" data-toggle="tab">Forms</a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="products" style="padding:15px;">
                    ...
                    <div class="form-group" id="act_att_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_att" id="act_att" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'AT&T') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="checkbox" name="att_allow_byos" id="att_allow_byos" value="Y" {{ Auth::user()->account_type == 'L' ? '' : 'disabled' }}/>
                    ...
                    <div class="form-group" id="act_boom_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_boom" id="act_boom" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'Boom') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="text" name="boom_min_month" id="boom_min_month"
                                   style="width:40px;float:left;"
                                   class="form-control" {{ Auth::user()->account_type == 'L' ? '' : 'readonly' }}/>
                            <strong>&nbsp; Minimum Activation Months</strong>
                        </div>
                    ...
                    <div class="form-group" id="act_freeup_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_freeup" id="act_freeup" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'FreeUP') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="text" name="freeup_min_month" id="freeup_min_month"
                                   style="width:40px;float:left;"
                                   class="form-control" {{ Auth::user()->account_type == 'L' ? '' : 'readonly' }}/>
                            <strong>&nbsp; Minimum Activation Months</strong>
                        </div>
                    ...
                    <div class="form-group" id="act_gen_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_gen" id="act_gen" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'GEN Mobile') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="text" name="esn_swap_num" id="esn_swap_num"
                                   style="width:40px;float:left; display: none;"
                                   class="form-control" {{ Auth::user()->account_type == 'L' ? '' : 'readonly' }}/>
                            <strong>&nbsp;Minimum Activation Months</strong>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="act_h2o_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_h2o" id="act_h2o" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'H2O') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="text" name="h2o_min_month" id="h2o_min_month"
                                   style="width:40px;float:left;"
                                   class="form-control" {{ Auth::user()->account_type == 'L' ? '' : 'readonly' }}/>
                            <strong>&nbsp;Minimum Activation Months</strong>
                        </div>
                    ...
                    <div class="form-group" id="act_liberty_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_liberty" id="act_liberty" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'Liberty') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="text" name="liberty_min_month" id="liberty_min_month"
                                   style="width:40px;float:left;"
                                   class="form-control" {{ Auth::user()->account_type == 'L' ? '' : 'readonly' }}/>
                            <strong>&nbsp;Minimum Activation Months</strong>
                        </div>
                    ...
                    <div class="form-group" id="act_lyca_box">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-3">
                            <input type="checkbox" name="act_lyca" id="act_lyca" value="Y" {{ Auth::user()->account_type == 'L' || \App\Lib\Helper::has_activation_controller_auth(Auth::user()->account_id, 'Lyca') ? '' : 'disabled' }}/>
                            <strong>&nbsp; Allow Activation or not </strong>
                            <br>
                            <input type="text" name="lyca_min_month" id="lyca_min_month"
                                   style="width:40px;float:left;"
                                   class="form-control" {{ Auth::user()->account_type == 'L' ? '' : 'readonly' }}/>
                            <strong>&nbsp;Minimum Activation Months</strong>
                        </div>
...
{{--                        </div>--}}
                    ...
                    <div class="form-group credit-limit" id="div_current_balance">
                        <label class="col-sm-3">Current Balance</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group no_postpay">
                        <div style="{{ Auth::user()->account_type == 'L' ? '' : 'display:none;' }}">
                            <label class="col-sm-3 no_postpay">Do not allow to create postpay accounts</label>
                            <div class="col-sm-3 no_postpay">
                ...
                <div role="tabpanel" class="tab-pane" id="forms" style="padding:15px;">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Uniform Sales and Use Certificate: <span id="esig_usuc_box"><br><a class="float:right" href="/admin/esig/FILE_PR_SALES_TAX" target="_blank">eSignature</a></span><br><a class="float:right" href="/upload_template/PR_SALES_TAX.pdf" target="_blank">form download</a></label>
                        <div class="col-sm-4" style="margin-top:8px;">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">ACH Doc : <span id="esig_ach_box"><br><a class="float:right" href="/admin/esig/FILE_ACH_DOC" target="_blank">eSignature</a></span><br><a class="float:right" href="/upload_template/ACH_FORM.pdf" target="_blank">form download</a><br><a class="float:right" href="/upload_template/Check_List.pdf" target="_blank">Check List</a></label>
                        <div class="col-sm-4" style="margin-top:8px;">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">H2O Dealer Form : <span id="esig_ach_box"><br><a class="float:right" href="/admin/esig/FILE_H2O_DEALER_FORM" target="_blank">eSignature</a></span><br><a class="float:right" href="/upload_template/ACH_FORM.pdf" target="_blank">form download</a><br><a class="float:right" href="/upload_template/Check_List.pdf" target="_blank">Check List</a></label>
                        <div class="col-sm-4" style="margin-top:8px;">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">H2O ACH : <span id="esig_ach_box"><br><a class="float:right" href="/admin/esig/FILE_H2O_ACH" target="_blank">eSignature</a></span><br><a class="float:right" href="/upload_template/ACH_FORM.pdf" target="_blank">form download</a><br><a class="float:right" href="/upload_template/Check_List.pdf" target="_blank">Check List</a></label>
                        <div class="col-sm-4" style="margin-top:8px;">
            ...
            <ul class="pager wizard">
                <li class="previous first" style="display:none; background-color: red; color: white; font-weight: bold;"><a href="#">First</a></li>
                <li class="previous"><a href="#" style="background-color: red; color: white; font-weight: bold;">Previous</a></li>
                <li class="next last" style="display:none;"><a href="#" style="background-color: red; color: white; font-weight: bold;">Last</a></li>
                <li class="next"><a href="#" style="background-color: red; color: white; font-weight: bold;">Next</a></li>
                <li class="finish"><a href="javascript:;" style="float:right; background-color: red; color: white; font-weight: bold;">Finish</a></li>
            </ul>

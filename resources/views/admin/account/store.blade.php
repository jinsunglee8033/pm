...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function update_hour(day) {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/admin/account/store/update',
                data: {
                    _token: '{!! csrf_token() !!}',
                    day: day,
                ...
                success: function(res) {
                    ...
                    if ($.trim(res.msg) === '') {
                        ...
                        myApp.showSuccess('Your request has been processed successfully!', function() {
                            location.href = "/admin/account/store";
                        });
        ...
        function remove_hour(day) {
            myApp.showLoading();
            $.ajax({
                url: '/admin/account/store/remove',
                data: {
                    _token: '{!! csrf_token() !!}',
                    day: day,
                    stime: $('#'+day+'_stime').val(),
        ...
        function remove_ip(id) {
            myApp.showLoading();
            $.ajax({
                url: '/admin/account/store/remove-ip',
                data: {
                    _token: '{!! csrf_token() !!}',
                    id: id
                },
        ...
        function add_ip() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/admin/account/store/add-ip',
                data: {
                    _token: '{!! csrf_token() !!}',
                    ip: $('#add_ip').val(),
        ...
        function update_ip(id) {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/admin/account/store/update-ip',
                data: {
                    _token: '{!! csrf_token() !!}',
                    id: id,
                    ip: $('#ip_'+id).val(),
        ...
        function update_tz() {
            ...
            myApp.showLoading();
            $.ajax({
                url: '/admin/account/store/update-tz',
                data: {
                    _token: '{!! csrf_token() !!}',
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <hr><br>
                    <h4><p style="text-align:center"><a href="/admin/account/user-hour">If you want to control access by users Please click here</a></p></h4>
                </div>

                                ...
                                transactions: [
                                    {
                                        ...
                                        invoice_number: 'E-' + $('#n_invoice_no').val()
                                    }
                                ]
                            },
                            experience: {
                    ...
                    <div class="page-header">
                        ...
                        <div class="page-header-top">
                            <div class="container">
                                ...
                                <div class="page-logo">
                                    <a href="#">
                                        <img src="/mall/assets/layouts/layout3/img/logo-freeup.png" alt="logo" class="logo-default">
                                    </a>
                                </div>
                                <!-- END LOGO -->
                                <div class="top-menu">
                            ...
                            <div class="page-head2">
                                <div class="container">
                                    ...
                                    <div class="btn-group btn-group btn-group-justified">
                                        <a href="/freeup/activate" class="btn grey"> <h4>ACTIVATION</h4> </a>
                                        <a href="/freeup/recharge" class="btn dark"><h4>PIN PURCHASE</h4> </a>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <form class="form-horizontal" id="frm_recharge" role="form" method="post" action="/rok/recharge" onsubmit="myApp.showLoading();">
                                                    ...
                                                    \Carbon\Carbon::now()->format('ymdhms') }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4 ">
                                                            <select class="form-control" name="denom_id" id="denom_id" onchange="calc_total()">
                                                                ...
                                                                @foreach ($denoms as $d)
                                                                <option value="{{ $d->id }}" price="{{ $d->denom }}">${{ $d->denom . ' ' . $d->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @foreach ($denoms as $d)
                                                            <input id="val_{{ $d->id }}" value="{{ $d->denom }}" type="hidden">
                                                            <input id="vendor_fee_{{ $d->id }}" value="{{ $d->vendor_denom->fee }}" type="hidden">
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                    <div class="form-group">

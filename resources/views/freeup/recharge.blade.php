                            ...
                            <div class="page-head2">
                                <div class="container">
                                    ...
                                    <div class="btn-group btn-group btn-group-justified">
                                        ...
                                        <a href="/freeup/recharge" class="btn dark"> <h4>RECHARGE</h4> </a>
                                    </div>
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <form class="form-horizontal" id="frm_recharge" role="form" method="post" action="/rok/recharge" onsubmit="myApp.showLoading();">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-4 control-label"><span class="sbold"><font color="#4B77BE">Product</font></span></label>
                                                        <div class="col-md-4 ">
                                                            <select class="form-control" name="denom_id" id="denom_id" onchange="calc_total()">
                                                                ...
                                                                @foreach ($denoms as $d)
                                                                <option value="{{ $d->id }}" price="{{ $d->denom }}">${{ $d->denom }}</option>
                                                                @endforeach
                                                            </select>
                                                            @foreach ($denoms as $d)
                                                            <input id="val_{{ $d->id }}" value="{{ $d->denom }}" type="hidden">
                                                            <input id="vendor_fee_{{ $d->id }}" value="{{ $d->fee }}" type="hidden">
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-4 control-label">Month of Refill</label>
                                                        <div class="col-md-4 ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body receipt">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">FreeUp Prepaid</div>
                        </div>
                        <div class="row">

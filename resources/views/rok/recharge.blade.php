...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function reset_form(reset_phone) {
                if (typeof reset_phone === 'undefined') {
                    reset_phone = true;
                }
                ...
                $('#product_id').empty();
                $('#product_id').append('<option value="">Please lookup phone # first</option>');
                $('#denom_id').empty();
                $('#denom_id').append('<option value="">Please lookup phone # first</option>');
                $('#rtr_month').val('1');
            }
            ...
            function isValid() {
                var phone = $('#phone').val();
                if ($.trim(phone) === '') {
                    //myApp.showError('Please enter phone number');
                    return false;
                }
            ...
            function lookup_phone() {

                myApp.showLoading();
                $.ajax({
                    url: '/rok/recharge/lookup-phone',
                    data: {
                        _token: '{!! csrf_token() !!}',
                        phone: $('#phone').val()
                    },
                    ...
                    success: function(res) {
                        ...
                        if ($.trim(res.msg) === '') {
                            ...
                            $('#product_id').empty();
                            $('#product_id').append('<option value="' + res.product.id + '" selected>' + res.product.name + '</option>');

                            $('#denom_id').empty();
                            $('#denom_id').append('<option value="' + res.denom.id + '" price="' + res.denom.denom + '" selected>' + res.denom.name + '</option>');

                            $('#denom_id').val(res.denom.id);

                            var fee = parseFloat(res.vendor_denom.fee) + parseFloat(res.vendor_denom.pm_fee);
                            $('#vendor_fee').val(fee.toFixed(2))

                            calc_total();

                            var event = new Event('lookup-done');
            ...
            function calc_total() {
                var denom = $.trim($('#denom_id option:selected').attr('price'));
                ...
                var fee = parseFloat($('#vendor_fee').val());
            ...
            function onChangeStatus(handler) {
                ...
                document.querySelector('#phone').addEventListener('lookup-done', handler);
                document.querySelector('#rtr_month').addEventListener('change', handler);
            }
        </script>
    </head>
    <!-- END HEAD -->
                    ...
                    <div class="page-header">
                        ...
                        <div class="page-header-top">
                            <div class="container">
                                ...
                                <div class="page-logo">
                                    <a href="#">
                                        <img src="/mall/assets/layouts/layout3/img/logo-default.png" alt="logo" class="logo-default">
                                    </a>
                                </div>
                                <!-- END LOGO -->
                                <div class="top-menu">
                ...
                <div class="page-wrapper-middle">
                            ...
                            <div class="page-head2">
                                <div class="container">
                                    ...
                                    <div class="btn-group btn-group btn-group-justified">
                                        <a href="/rok/activate" class="btn grey"> <h4>ACTIVATION</h4> </a>
                                        <a href="/rok/recharge" class="btn dark"><h4> RECHARGE</h4> </a>
                                    </div>
                                    ...
                                    <div class="page-content-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <form class="form-horizontal" id="frm_recharge" role="form" method="post" action="/rok/recharge" onsubmit="myApp.showLoading();">
                                                    {!! csrf_field() !!}
                                                    <div class="form-group">
                                                        <label for="inputEmail12" class="col-md-5 control-label"><span class="sbold"><font color="#4B77BE">Phone #</font></span></label>
                                                        <div class="col-md-4">
                                                            <input class="form-control" type="text" id="phone" name="phone" maxlength="10" placeholder="10 digits and digit only." onchange="reset_form(false)"/>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <button type="button" onclick="lookup_phone()" class="btn default">Look up</button>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-5 control-label">Product</label>
                                                        <div class="col-md-4 ">
                                                            <select class="form-control" name="product_id" id="product_id">
                                                                <option value="">Please lookup phone # first</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-5 control-label">Amount</label>
                                                        <div class="col-md-4 ">
                                                            <select class="form-control" name="denom_id" id="denom_id">
                                                                <option value="">Please lookup phone # first</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-5 control-label">Month of Refill</label>
                                                        <div class="col-md-4 ">
                                                            <select class="form-control" id="rtr_month" name="rtr_month" onchange="calc_total()">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-5 control-label"><b>Sub Total</b></label>
                                                        <div class="col-md-4 ">
                                                            <input type="text" class="form-control" id="sub_total" name="sub_total" readonly value="0.00"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" style="display:none;">
                                                        <label for="inputPassword1" class="col-md-5 control-label"><b>Vendor Fee</b></label>
                                                        <div class="col-md-4 ">
                                                            <input type="text" class="form-control" id="vendor_fee" name="vendor_fee" readonly value="0.00"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputPassword1" class="col-md-5 control-label"><b>Total</b></label>
                                                        <div class="col-md-4 ">
                    ...
                    <div class="page-footer">
                        <div class="container text-center"> 2017 ~ {{ date('Y') }} &copy; Copyright
                            <a target="_blank" href="http://SoftPayㅖlus.com">SoftPayPlus</a> All rights Reserved.
                        </div>
                    </div>
